...
function UploadPdf() {
  ...
  return (
    ...
    <div className="flex items-center p-1 px-4 py-2 bg-[#fff4f4] border-b border-gray-300">
      <h2 className="text-lg text-black bg-pink-100 text-purple-600 rounded-lg px-4 font-semibold">History</h2>
      <button
