...
function HeaderForLogin({ navigate }) {
  ...
  return (
    ...
    <div className="w-full max-w-md mb-8 flex justify-between items-center">
      ...
      <div className="space-x-4">
        <button
          onClick={() => navigate('/forgot-password')} // Use the passed-in navigate function
          className="text-sm text-purple-600 hover:text-purple-800 hover:underline transition duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded" // Added focus styles
        >
          Forgot Password?
        </button>
        <button
