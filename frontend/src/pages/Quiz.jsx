...
//   const [isQuizSubmitted, setIsQuizSubmitted] = useState(false); // Track quiz submission status
...
//         setIsQuizSubmitted(true); // Set quiz submission status to true
//       } else {
