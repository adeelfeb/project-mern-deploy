...
//       // Format relevant context from vector data
...
//       console.log("the promp:", enhancedPrompt)
...
//       const fallbackResponse = await generateContentWithRetry([currentMessage]); // Fallback logic
