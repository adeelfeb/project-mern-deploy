...
function Signup() {
  ...
  const create = async (data) => {
    ...
    try {
      ...
      // console.log("The created user is:", createdUser, temporaryToken)
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center  bg-gradient-to-r from-indigo-50 to-purple-50">
              ...
              <div className="mt-4">
                ...
                <div className="mt-2 flex items-center">
                  <input
                    ...
                    className="block w-full text-sm text-gray-500 border rounded-lg p-2 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  />
