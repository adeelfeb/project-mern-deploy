  ...
  return (
    ...
    `}>
      <div className="flex flex-col flex-1 gap-4 mt-2">
        <Link to="/dashboard/input-url" className={`flex flex-col items-center justify-center p-2 rounded-md hover:bg-gray-200 ${isActive('/dashboard/input-url') ? 'bg-gray-100' : ''}`}>
      ...
      <div className="flex flex-col items-center p-2 gap-4 border-t">
        ...
        <Link to="/dashboard/settings" className={`flex flex-col items-center justify-center p-2 rounded-md hover:bg-gray-200 ${isActive("/dashboard/settings") ? "bg-gray-100" : ''}`}>
